...
<p align="center">
  <strong>
    <a href="http://demo.themewagon.com/preview/bootstrap-4-free-admin-template" target="_blank">View Demo</a> | 
	<a href="https://themewagon.com/themes/bootstrap-4-free-admin-template/" target="_blank">Download ZIP</a>
  </strong>
</p>

[ModularAdmin](https://themewagon.com/themes/bootstrap-4-free-admin-template/) is an open source dashboard theme built in a modular way. That makes it extremely easy to scale, modify and maintain.
...
### 1. [Download ZIP](https://github.com/technext/modular-admin) or Git Clone

```
git clone https://github.com/technext/modular-admin.git
```
### 2. Build the project
